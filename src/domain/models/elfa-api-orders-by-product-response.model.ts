...
export class ElfaApiOrderByProductResponseModel {
  ...
  private convertOrderEmissionToDate(orderEmission: string): Date | null {
    if (!orderEmission) {
      console.error('OrderEmission is null or undefined');
      return null;
    }
...
export class ElfaApiOrderByProductViewResponseModel {
  public code: string;
  public codeInventory: number;
  public invoiceNumber: string | null;
  public invoiceSeries: string | null;
  public requestedAt: Date;
  public storeDocument: string;
  public type?: EOrderType;
  ...
  constructor(init: Partial<ElfaApiOrderByProductViewResponseModel>) {
